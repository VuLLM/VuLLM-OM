...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_type="train"):
        ...
        if "processed_func" in df.columns:
            ...
            func_key = "func"
        # df = df[df[func_key].str.len() <= 5000]
        df = df.drop_duplicates(subset=func_key, keep='first')  # Drop duplicates
    ...
    if args.do_test:
        if os.path.exists(args.model_name):
            ...
            if not os.path.exists(output_dir):
                ...
                output_dir = os.path.join(args.output_dir, args.model_name, 'checkpoint-best-f1', 'model.bin')
        # output_dir = "detector_models/LineVul/saved_models/12heads_linevul_model.bin"
        ...
        # state_dict.pop("encoder.roberta.embeddings.position_ids", None)
