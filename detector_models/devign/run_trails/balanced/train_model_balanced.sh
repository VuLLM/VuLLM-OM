...
input_dirs=("data/balanced_0.2_train_input" "data/balanced_0.2_test_input" "data/real_world_nonvul_input")
...
if [ ! -z "$1" ]; then
    ...
    if [ "$1" == "simple" ]; then
        ...
        input_dirs=("data/balanced_0.2_train_input" "data/balanced_0.2_test_input")
    else
...
move_to_output
python main.py -p --num_epochs 15
move_back_to_original 
