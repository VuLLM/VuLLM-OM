...
def main(path_testset, model_huggingface_path, all_vulgen, output_dir):
    ...
    tokenized_local_test = Prepare_dataset_with_line_spaces.get_testset_for_eval(tokenizer, path_testset=path_testset, all_vulgen=all_vulgen, drop_index_path='pickle_files/location_with_spaces_to_delete_test.pkl')
