...
def main(path_trainset, path_testset, full_vulgen, output_dir, learning_rate, per_device_train_batch_size, num_train_epochs, generation_num_beams):    
    ...
    tokenized_train, tokenized_test = Prepare_dataset_with_line_spaces.create_datasets(tokenizer, path_trainset, path_testset, full_vulgen=full_vulgen, 
                                                                                       drop_indexes_train_path='pickle_files/location_with_spaces_to_delete_train.pkl',
                                                                                       drop_indexes_test_path='pickle_files/location_with_spaces_to_delete_test.pkl')
